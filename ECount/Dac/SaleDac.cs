...
namespace ECount.Dac
{
    class SaleDac
    {
        ...
        //static IStore<SaleHistoryModel> store = new InMemoryStore<SaleHistoryModel>();            //메모리저장
        static IStore<SaleHistoryModel> store = InFileStore<SaleHistoryModel>.Get("sale.dat");       //파일 저장
